...
// added a var function for replayability and wrapped for loop with it
var startGame = function(){
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
      ...
      if (playerInfo.health > 0 && i < enemyInfo.length - 1){
        // ask if player would like to  use the store before next round
 ...
 var endGame = function() {
  ...
  if (playAgainConfirm){
    // restart game with start game function
    startGame()
  }
  else{
...
var getPlayerName = function() {
  ...
  console.log("Your eobot's name is " + name);
  return name;
};
